...
void DominoStateView::draw() {
    app.clear(sf::Color::Blue);
    app.draw(centerText);
    app.draw(buttonDomino);
}

DominoStateView::DominoStateView(sf::RenderWindow & window) : app{window}, buttonDomino{"Domino"}, centerText{TuileView::createText("Domino", 50, Color::Black)}{
    //init ici;
